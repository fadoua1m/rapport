...
\begin{center}
{\LARGE{\textbf{\textsc{Rapport de Projet de Fin d'Ann\'ee}}}}\\
\vskip0.5cm
\large

{\textbf{Présenté en vue de la validation de la deuxième année du}}\\
\vskip2mm
{\textbf{\@diplomaName}}\\
...
\begin{figure}[h]
\centering
{\color{isiBlue}{\fboxrule=1pt\fbox{\includegraphics[width=0.2\columnwidth]{Logo_Entreprise.jpg}}}}
\end{figure}
\end{center}
