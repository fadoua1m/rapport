...
\title{Conception d’un chatbot RH pour l’automatisation des demandes de congés et l’assistance sur les règles internes de l’entreprise}
...
\speciality{Ingénierie de Développement du Logiciel}
%\speciality{Génie des Télécommunications et Réseaux}
%\speciality{Génie Informatique des Systèmes Industriels}

%% Encadrant professionnel
\proFramerName{Monsieur Khaled  AMROUCHE}
\proFramerSpeciality{Chef Technique}

%% Encadrant académique
\academicFramerName{Madame Sonia ZAOUALI}
\academicFramerSpeciality{Maître Assistante}

%% Entreprise d'accueil
\companyName{Astrolab Group}
